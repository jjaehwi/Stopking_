...
public class RegisterDrinkEmail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkEmail = findViewById(R.id.tv_emailCheck);
        ...
        mbtnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    // 일주일에 마시는 총 병수
                    intAvgDrink = avgDrink.replaceAll("[^0-9]", "");
                    weekBottle = Integer.parseInt(weekDrink) * Integer.parseInt(intAvgDrink);
                            ...
                            if (task.isSuccessful())
                            {
                                ...
                                fbUser.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                loginFlag=1;
                                                //인증 메일이 성공적으로 보내진 경우.
                                                Toast.makeText(RegisterDrinkEmail.this, "이메일을 성공적으로 전송하였습니다. 인증을 진행해주세요.", Toast.LENGTH_SHORT).show();
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(RegisterDrinkEmail.this, "해당 이메일은 존재하지 않습니다. 다시 시도하세요.", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                            else { // 회원가입 실패한 경우
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful())
                                {
                                    ...
                                    if (fbUser.isEmailVerified())
                                    {
                                        ...
                                        Toast.makeText(RegisterDrinkEmail.this, "이메일 인증 성공!", Toast.LENGTH_SHORT).show();
                                    ...
                                    {
                                        Toast.makeText(RegisterDrinkEmail.this, "이메일 인증을 해주세요.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        });
        ...
        mbtnComplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(RegisterDrinkEmail.this, "이메일 인증을 진행해주세요!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
